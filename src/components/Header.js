    ...
    return (
        <Section>
            ...
            <MenuDiv>
                ...
                (
                <>
                    <HamburgerMenu onClick={() => setIsSidebarOpen(!isSidebarOpen)} width="80px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {isSidebarOpen ? <SideBar isSidebarOpen={isSidebarOpen}>
                        <SideBarLink aria-label="Return to Locations Home Page" to="/" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>Home</SideBarLink>
                        <SideBarLink aria-label="Control webpage settings" to="/settings" onClick={() => setIsSidebarOpen(!isSidebarOpen)}>Settings</SideBarLink>
                    </SideBar>
                    : null}
                </>
                )}
