    ...
    return (
        <Section>
            ...
            <MenuDiv>
                ...
                (
                <>
                    <HamburgerMenu ref={node} onClick={() => setIsSidebarOpen((prev) => !prev)} width="80px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <SideBar ref={node} isSidebarOpen={isSidebarOpen}>
