    ...
    return (
        <Section>
            ...
            <MenuDiv>
                ...
                (
                <>
                    <HamburgerMenu ref={node} onClick={() => setIsSidebarOpen(!isSidebarOpen)} width="80px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {isSidebarOpen ? <SideBar isSidebarOpen={isSidebarOpen}>
                        <SideBarLink onClick={() => setIsSidebarOpen(!isSidebarOpen)} aria-label="Return to Locations Home Page" to="/">Home</SideBarLink>
                        <SideBarLink onClick={() => setIsSidebarOpen(!isSidebarOpen)} aria-label="Control webpage settings" to="/settings">Settings</SideBarLink>
                    </SideBar>
                    : null}
                </>
                )}
